...
import cpe_api.api_functions as api_functions

from sqlalchemy.orm import Session
from unittest import TestCase, mock
from sqlalchemy import create_engine, Engine
from cpe_parser import CpeParser
from database_engine.model import Base, CPE, CPE23, Reference
...
class TestAPIFunctions(TestCase):
    ...
    def test_check_cpe(self):
        with mock.patch('cpe_api.api_functions.get_engine', return_value=self.engine):
    ...
    def test_get_common_products(self):
        with mock.patch('cpe_api.api_functions.get_engine', return_value=self.engine) as m:
    ...
    def test_get_mismatched_vendor_names(self):
        with mock.patch('cpe_api.api_functions.get_engine', return_value=self.engine) as m:
            ...
            assert result == [('micro$oft', 'microsoft')]
